...
class RecipeSerializer(serializers.ModelSerializer):
    """Сериализатор для Cоздания, Редактирования, Удаления рецепта."""
    ...
    class Meta:
        ...
        validators = [
            UniqueTogetherValidator(
                ...
                fields=('user', 'recipe'),
                message='Этот рецепт уже был добавлен в избранное'
            )
        ]
    ...
    class Meta:
        ...
        validators = [
            UniqueTogetherValidator(
                ...
                fields=('user', 'recipe'),
                message='Этот рецепт уже был добавлен в список покупок'
            )
        ]
